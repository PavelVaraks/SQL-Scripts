...
CREATE PROCEDURE sp_FailedJobs @fromdate ='2018-01-01 23:05:01.857', @todate='2018-07-24 23:05:01.857'
(
...
IF @FromDate IS NULL BEGIN SET @FromDate = select DATEADD(Minute,-720,GETDATE()) END
