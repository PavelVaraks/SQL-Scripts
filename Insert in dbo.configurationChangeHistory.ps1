...
$SQLServerListQuery="declare @command nvarchar(max)
set @command= 
'
...
"
[array]$ServerList=Invoke-Sqlcmd2 -ServerInstance localhost -Query $SQLServerListQuery 
...
EXEC sys.sp_executesql @command
"
[array]$configurationChangeHistoryResult=Invoke-Sqlcmd2 -ServerInstance $ServerInstance  -Query $configurationChangeHistoryQuery
